    ...
    return this.ui.prompt({
      ...
      choices: [
        new inquirer.Separator('flexi-default-styles - Default flexi styles'),
        {
          ...
          value: { name: '@html-next/flexi-default-styles', target: '~2.0.0-beta.9' }
        },
        new inquirer.Separator('flexi-dsl - Converts attributes to classes'),
        {
          checked: true,
          name: 'flexi-dsl',
          value: { name: '@html-next/flexi-dsl', target: '~2.0.0-beta.7' }
        },
        new inquirer.Separator('flexi-layouts - Layout service and grids'),
        {
          checked: true,
          name: 'flexi-layouts',
          value: { name: '@html-next/flexi-layouts', target: '~2.0.0-beta.7' }
        },
